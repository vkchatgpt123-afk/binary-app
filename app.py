...
# =========================================================
# SIGNAL TERMINAL V4.9.8 — FINAL STABLE FIX
# =========================================================

st.set_page_config(
    page_title="Signal Terminal V4.9.8",
    page_icon="📊",
    layout="centered",
...
# =========================================================
# PAIRS & TIMEFRAME (UNIQUE KEYS TO PREVENT DUPLICATE ERROR)
# =========================================================
...
with col1:
    pair = st.selectbox("PAIR", list(PAIRS.keys()), key="unique_pair_selectbox_v498")
with col2:
    timeframe = st.selectbox("TIMEFRAME", list(TIMEFRAMES.keys()), key="unique_tf_selectbox_v498")
